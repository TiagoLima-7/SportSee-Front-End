...
//   const elapsedTime = useElapsedTime(2000);

//   const barCount = sessions.length * 2;
//   const delayPerBar = 2000 / barCount;
//   const riseDuration = delayPerBar * 0.5;
//   const fallDuration = delayPerBar * 0.5;
...
//   const getAnimatedValue = (finalValue, index, scale) => {
//     const start = index * delayPerBar;
//     const riseEnd = start + riseDuration;
//     const fallEnd = start + riseDuration + fallDuration;

//     if (elapsedTime <= start) return 0;
//     if (elapsedTime >= fallEnd) return finalValue;

//     const maxValue = scale.domain()[1];

//     if (elapsedTime <= riseEnd) {
//       const t = (elapsedTime - start) / riseDuration;
//       return maxValue * t;
//     }

//     const t = (elapsedTime - riseEnd) / fallDuration;
//     return maxValue + (finalValue - maxValue) * t;
//   };
...
//             const kgIndex = dayIndex * 2;
//             const calIndex = dayIndex * 2 + 1;

//             const animatedKg = getAnimatedValue(s.kilogram, kgIndex, yKgScale);
//             const animatedCal = getAnimatedValue(
//               s.calories,
//               calIndex,
//               yCalScale,
//             );
...
//                 <rect
//                   x={center - barWidth - barGap / 2}
//                   y={yKgScale(animatedKg)}
//                   width={barWidth}
//                   height={innerH - yKgScale(animatedKg)}
//                   fill="#282D30"
//                   rx="3"
//                 />
...
//                 <rect
//                   x={center + barGap / 2}
//                   y={yCalScale(animatedCal)}
//                   width={barWidth}
//                   height={innerH - yCalScale(animatedCal)}
//                   fill="#E60000"
//                   rx="3"
//                 />
//               </g>
